...
1) Run `./gradlew :filmstrip-core:publishToMavenLocal`
2) Open `~/.m2/repository/dev/jordond/filmstrip/`
...
2) Add developer id, name, email and the project url to  
   `./filmstrip-core/build.gradle.kts`
...
4) Add these lines to `gradle.properties`:
   ...
   ```
5) Run `./gradlew :filmstrip-core:publishAndReleaseToMavenCentral --no-configuration-cache`
