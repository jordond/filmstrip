 ...
 * right.
 *
 * A reference to an image rather than decoded pixels, so a composition holding one stays cheap to
 * copy and to compare. The backend decodes it when it renders. Construct one through the companion
