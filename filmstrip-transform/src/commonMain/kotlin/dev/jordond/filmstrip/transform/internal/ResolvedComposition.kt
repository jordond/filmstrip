 ...
 *   export, and the frame an export would write for a graph lowered smaller than that, such as a
 *   preview under a quality cap. A backend hands this to a resolver rather than working it out from
